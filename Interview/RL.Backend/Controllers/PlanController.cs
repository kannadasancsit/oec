...
public class PlanController : ControllerBase
{
    ...
    [HttpPost("AddUsersProcedureToPlan")]
    public async Task<IActionResult> AddUsersToProcedurePlan(AddUsersToProcedurePlanCommand command, CancellationToken token)
    {
        var response = await _mediator.Send(command, token);
