...
public class RLContext : DbContext
{
    ...
    public DbSet<PlanProcedureUsers> PlanProceduresUsers { get; set; }
    ...
    protected override async void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<PlanProcedureUsers>(typeBuilder =>
        {
            typeBuilder.HasKey(pp => new { pp.ProcedureId, pp.PlanId, pp.UserId });
            ;
            typeBuilder.HasOne(d => d.Plan)
                   .WithMany(p => p.PlanProceduresUsers)
